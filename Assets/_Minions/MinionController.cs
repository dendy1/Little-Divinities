...
public class MinionController : MonoBehaviour
{
    ...
    //     {
    //         GameManager.Instance.SetActiveVacationIslandOutline(false);
    //         GameManager.Instance.SetActiveMergeIslandOutline(false);
    //     }
    //     else
    //     {
    ...
    //         }
    //         
    //         _mainIsland.GetComponent<IslandController>().SetActiveOutline(true);
    //     }
    //     
