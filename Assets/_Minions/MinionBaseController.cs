...
public class MinionBaseController : MonoBehaviour
{
    ...
    //     
    //     GameManager.Instance.SetActiveIslandsOutline(true);
    //     islandController.SetActiveOutline(true);
    // }
    //
    ...
    //             {
    //                 if (ShopManager.Instance.BuyMinion(cost))
    //                 {
